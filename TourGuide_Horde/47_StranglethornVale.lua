...
T Grim Message |T| |QID|2932|

C Raptor Mastery (Part 4) |N|Kill Tethis (28.7,44.9)| |QID|197|
...
T Rescue OOX-22/FE! |T| |O| |QID|2767|
...
A Message in a Bottle (Part 2) |N|May require assistance to complete| |QID|630|
...
H Booty Bay |N|or die on purpose|
T The Captain's Chest |T| |QID|614|
N [Silk Cloth] |T| |N|Have 15x Silk Cloth for a later quest, if possible| |L|4306 15|
T The Bloodsail Buccaneers (Part 5) |T| |QID|608|

A The Green Hills of Stranglethorn |N|If you have all the pages| |QID|338|
